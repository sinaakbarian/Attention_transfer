...
train_df_path ="/scratch/gobi2/sinaakb/CheXpert/split/new_train.csv"
test_df_path ="/scratch/gobi2/sinaakb/CheXpert/split/new_test.csv"
val_df_path = "/scratch/gobi2/sinaakb/CheXpert/split/new_valid.csv"
...
def main():
    ...
    if MODE =="test":
        ...
        weights=torch.load('results/checkpoint-4')
    ...
    if MODE == "plot":
        gt = pd.read_csv("./results/True-sin.csv")
        pred = pd.read_csv("./results/bipred-sin.csv")
        factor = [gender, Age]
        factor_str = ['Sex', 'Age']
