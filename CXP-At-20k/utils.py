...
def checkpoint(model, iteration):
    """
    Saves checkpoint of torchvision model during training.
    Args:
    ...
    torch.save(state, '/scratch/gobi1/sinaakb/xray/5k/same/AT-mimic/checkpoint-all-reintiallized_AT-mimic-alldata---7--'+str(iteration))
