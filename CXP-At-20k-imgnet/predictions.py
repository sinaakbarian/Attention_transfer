...
#                     indices = rng.random_integers(0, len(actual.to_numpy().astype(int)) - 1, len(pred.to_numpy()))
#                     if len(np.unique(actual.to_numpy().astype(int)[indices])) < 2:
#                         continue

#                     score = sklm.roc_auc_score(
#                         actual.to_numpy().astype(int)[indices], pred.to_numpy()[indices])
